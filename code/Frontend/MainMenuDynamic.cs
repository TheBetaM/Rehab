...
public partial class MainMenuDynamic : Control
{
    ...
    string DemoCheck = RehabGame.AssetsPath + "Rigs/Actor/Chars/Cortex/Anims/Cortex_SkateFall.anim";
    ...
    public async void StartAnim()
    {
        ...
        if (ActorsExist)
        {
            ...
            ActorNode.GetNode<AnimationPlayer>("AnimationPlayer").Stop();
            ActorNode.GetNode<AnimationPlayer>("AnimationPlayer").Play(null, 0d);
        }

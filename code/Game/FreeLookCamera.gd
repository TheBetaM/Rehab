...
func UpdateCamControls(delta):
	...
	if Input.is_action_pressed("pad1_rstick_left"):
		global_rotation_degrees.y += 90.0 * delta * Input.get_action_strength("pad1_rstick_left")
	elif Input.is_action_pressed("pad1_rstick_right"):
		global_rotation_degrees.y += -90.0 * delta  * Input.get_action_strength("pad1_rstick_right")
	if Input.is_action_pressed("pad1_rstick_up"):
		global_rotation_degrees.x += 90.0 * delta * Input.get_action_strength("pad1_rstick_up")
	elif Input.is_action_pressed("pad1_rstick_down"):
		global_rotation_degrees.x += -90.0 * delta  * Input.get_action_strength("pad1_rstick_down")

...
namespace Twinsanity.VIF
{
    public class Vector4
    {
        ...
        public uint BX { get => GetBinaryX(); } //debug
        public uint BY { get => GetBinaryY(); } //debug
        public uint BZ { get => GetBinaryZ(); } //debug
        public uint BW { get => GetBinaryW(); } //debug
        public PackFormat FMT;
        public Vector4()
        {
            X = 0.0f;
            Y = 0.0f;
